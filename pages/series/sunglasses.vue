...
<template>
  <div>
    <section
      class="flex"
      role="img"
      aria-label="沙灘下的太陽眼鏡有效阻隔紫外線的侵害及戴著太陽眼鏡的金髮模特非常美麗"
    >
      <picture class="w-1/2" aria-hidden="true">
        <source
          srcset="/images/product-header-3.png"
          media="(min-width: 769px)"
        />
        <img
          src="/images/product-header-sm-3.png"
          alt="Glasses Sunglass 形象照 1"
          class="object-cover w-full h-full"
        />
      </picture>
      <picture class="w-1/2" aria-hidden="true">
        <source
          srcset="/images/product-header-4.png"
          media="(min-width: 769px)"
        />
        <img
          src="/images/product-header-sm-4.png"
          alt="Glasses Sunglass 形象照 2"
          class="object-cover w-full h-full"
        />
      </picture>
    </section>
